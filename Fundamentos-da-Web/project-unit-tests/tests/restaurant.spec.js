...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu()).toEqual(expect.objectContaining({ fetchMenu: expect.any(Function) }));
    ...
    // ```
    const objectReturn1 = createMenu({ food: {}, drink: {} });
    expect(objectReturn1.fetchMenu()).toMatchObject({ food: {}, drink: {} });
    ...
    // ```
    const objectReturn2 = createMenu({ food: { sushi: 'temaki' }, drink: {} });
    expect(objectReturn2.fetchMenu()).toMatchObject({ food: { sushi: 'temaki' }, drink: {} });
    // TESTE 4: Verifique se 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.consumption // Retorno: []
    // ```
    const objectReturn3 = createMenu({ food: { sushi: 'temaki' }, drink: {} });
    expect(objectReturn3.consumption).toEqual([]);
    ...
    // ```
    const objectReturn4 = createMenu({ food: { sushi: 'temaki' }, drink: {} });
    objectReturn4.order('coxinha');
    expect(objectReturn4.consumption).toEqual(['coxinha']);
    ...
    // ```
    const objectReturn5 = createMenu({ food: {}, drink: {} });
    objectReturn5.order("coxinha");
    objectReturn5.order("agua");
    objectReturn5.order("sopa");
    objectReturn5.order("sashimi");
    expect(objectReturn5.consumption).toEqual(["coxinha", "agua", "sopa", "sashimi"]);
    ...
    // ```
    const objectReturn6 = createMenu({ food: {}, drink: {} });
    objectReturn6.order("coxinha");
    objectReturn6.order("agua");
    objectReturn6.order("coxinha");
    expect(objectReturn6.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    const objectReturn7 = createMenu({ food: { 'coxinha': 3.9 }, drink: { 'agua': 3.9 } });
    objectReturn7.order('coxinha');
    objectReturn7.order('agua');
    objectReturn7.order('coxinha');
    expect(objectReturn7.pay()).toBe('12.87');
  });
});
